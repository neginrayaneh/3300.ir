...
if (!is_null($name) && (!is_null($phone) || !is_null($email)) && !is_null($message)) {
	...
	if ($_POST["g-recaptcha-response"]) {
		...
		if ($response != null && $response->success){
			...
			$mail->FromName   = 'Contact Request From 3300.ir';
...
<section id="home">
	<div class="center-container">
		<div class="center-field">
			...
			<p>
				<a href="documents/sms-service-number.html"
				   class="btn second-btn" target="_blank">
<!--					<i class="fa fa-file-text"></i>-->
					خدماتی نمودن شماره پیامک
				</a>
			</p>

            <p>
                <a href="/documents.html"
                   class="btn third-btn" target="_blank">
                    <!--					<i class="fa fa-file-text"></i>-->
                    مستندات فروش
                </a>
            </p>
								...
								<div id="collapseOne"
									...
									<div class="panel-body">
										<table class="table table-bordered table-striped table-responsive table-condensed">
											...
											<tbody>
											<tr>
                                                <td>نمونه کد PHP Rest API</td>
                                                <td>
                                                    <a href="/webservice/send sms with rest api - sample code.zip"
                                                       class="btn btn-success btn-sm">
                                                        <span class="fa fa-cloud-download"></span>
                                                    </a>
                                                </td>

												<td>نمونه کد PHP7 WebService</td>
												<td>
													<a href="/webservice/PHP7WEB.zip"
													   class="btn btn-success btn-sm">
														<span class="fa fa-cloud-download"></span>
													</a>
												</td>
											...
											<tr>
												<td>نمونه کد Delphi 2007 Windows</td>
												<td>
											...
											<tr>
												<td>نمونه کد Delphi 7 Windows</td>
												<td>
												...
												<td>نمونه کد Visual Basic 6 Windows</td>
												<td>
											...
											<tr>
												...
												<td>نمونه کد PHP5 WebService</td>
												<td>
													<a href="/webservice/PHP5WEB.zip"
													   class="btn btn-success btn-sm">
														<span class="fa fa-cloud-download"></span>
													</a>
												</td>
                                            ...
                                            <tr>
                                                <td>نمونه کد C# Rest API</td>
                                                <td>
                                                    <a href="/webservice/Csharp_Rest.zip"
                                                       class="btn btn-success btn-sm">
                                                        <span class="fa fa-cloud-download"></span>
                                                    </a>
                                                </td>
											...
											<tr>
                                                ...
                                                <td>راهنمای وب سرویس</td>
                                                <td>
                                                    <a href="/webservice/send-receive-guide.html"
                                                       class="btn btn-sm btn-success">
                                                        <span class="fa fa-eye"></span>  </a>
                                                </td>
                                                <td>راهنمای ارسال پیامک از طریق Url</td>
                                                <td>
                                                    <a target="_blank" href="webservice/send-sms-by-url.html"
                                                       class="btn btn-sm btn-success">
                                                        <span class="fa fa-eye"></span>
                                                    </a>
                                                </td>
		...
		<div class="center-field">
			<div class="container">
				...
				<a class="btn btn-blog btn-warning"
				   target="_blank"
				   href="https://virgool.io/@3300">وبلاگ نگين ارتباط
				</a>
			</div>
		</div>
	</div>
			...
			<div class="container">
				<div class="row">
					...
					<textarea class="form-control"
							...
							<div class="g-recaptcha" data-sitekey="6LdLbCAUAAAAAIWEziKx_EK-v6dPQdV-E8qwwtvD"></div>
